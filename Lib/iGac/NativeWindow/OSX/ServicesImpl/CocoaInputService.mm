    ...
    namespace presentation {
        ...
        namespace osx {
            ...
            void CocoaInputService::InitKeyMapping()
            {
                ...
                asciiLowerMap[VKEY::_5] = L'5';
                asciiLowerMap[VKEY::_6] = L'6';
                asciiLowerMap[VKEY::_7] = L'7';
                asciiLowerMap[VKEY::_8] = L'8';
                asciiLowerMap[VKEY::_9] = L'9';
                asciiLowerMap[VKEY::_OEM_1] = L';';
                asciiLowerMap[VKEY::_OEM_6] = L'[';
                asciiLowerMap[VKEY::_OEM_4] = L']';
                asciiLowerMap[VKEY::_OEM_7] = L'\'';
                asciiLowerMap[VKEY::_OEM_COMMA] = L',';
                asciiLowerMap[VKEY::_OEM_PERIOD] = L'.';
                asciiLowerMap[VKEY::_OEM_2] = L'/';
                asciiLowerMap[VKEY::_OEM_5] = L'\\';
                asciiLowerMap[VKEY::_OEM_MINUS] = L'-';
                asciiLowerMap[VKEY::_OEM_PLUS] = L'=';
                asciiLowerMap[VKEY::_OEM_3] = L'`';
                asciiLowerMap[VKEY::_SPACE] = L' ';
                ...
                asciiUpperMap[VKEY::_1] = L'!';
                asciiUpperMap[VKEY::_2] = L'@';
                asciiUpperMap[VKEY::_3] = L'#';
                asciiUpperMap[VKEY::_4] = L'$';
                asciiUpperMap[VKEY::_5] = L'%';
                asciiUpperMap[VKEY::_6] = L'^';
                asciiUpperMap[VKEY::_7] = L'&';
                asciiUpperMap[VKEY::_8] = L'*';
                asciiUpperMap[VKEY::_9] = L'(';
                asciiUpperMap[VKEY::_OEM_1] = L':';
                asciiUpperMap[VKEY::_OEM_6] = L'{';
                asciiUpperMap[VKEY::_OEM_4] = L'}';
                asciiUpperMap[VKEY::_OEM_7] = L'\"';
                asciiUpperMap[VKEY::_OEM_COMMA] = L'<';
                asciiUpperMap[VKEY::_OEM_PERIOD] = L'>';
                asciiUpperMap[VKEY::_OEM_2] = L'?';
                asciiUpperMap[VKEY::_OEM_5] = L'|';
                asciiUpperMap[VKEY::_OEM_MINUS] = L'_';
                asciiUpperMap[VKEY::_OEM_PLUS] = L'+';
                asciiUpperMap[VKEY::_OEM_3] = L'~';
                asciiUpperMap[VKEY::_SPACE] = L' ';
