...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			IMPL_CPP_TYPE_INFO(gacpass::NewCodeWindow)
			IMPL_CPP_TYPE_INFO(gacpass::NewCodeWindowConstructor)
...
#define _ ,
			BEGIN_CLASS_MEMBER(::gacpass::CodeBookWindow)
				...
				CLASS_MEMBER_CONSTRUCTOR(::gacpass::CodeBookWindow*(::vl::Ptr<::gacpass::IViewModel>, ::vl::presentation::controls::GuiWindow*), { L"__vwsn_ctor_parameter_ViewModel" _ L"__vwsn_ctor_parameter_MainWindow" })
			...
			BEGIN_INTERFACE_MEMBER(::gacpass::ICode)
				...
				CLASS_MEMBER_METHOD(Update, { L"viewmodel" _ L"website" _ L"username" _ L"password" })
				CLASS_MEMBER_PROPERTY_READONLY(Password, GetPassword)
				CLASS_MEMBER_PROPERTY_READONLY(Username, GetUsername)
				CLASS_MEMBER_PROPERTY_READONLY(Website, GetWebsite)
			END_INTERFACE_MEMBER(::gacpass::ICode)

			BEGIN_INTERFACE_MEMBER(::gacpass::ICodeBookViewModel)
				CLASS_MEMBER_BASE(::vl::reflection::IDescriptable)
				CLASS_MEMBER_METHOD(AddCode, { L"code" })
				CLASS_MEMBER_METHOD(CreateCode, NO_PARAMETER)
				CLASS_MEMBER_METHOD(GetCodes, NO_PARAMETER)
				CLASS_MEMBER_METHOD(GetSelectedCode, NO_PARAMETER)
				CLASS_MEMBER_METHOD(NotifyUpdate, { L"code" })
			...
			BEGIN_CLASS_MEMBER(::gacpass::LoginWindow)
				...
				CLASS_MEMBER_CONSTRUCTOR(::gacpass::LoginWindow*(::vl::Ptr<::gacpass::IViewModel>), { L"__vwsn_ctor_parameter_ViewModel" })
				CLASS_MEMBER_METHOD(GetViewModel, NO_PARAMETER)
				CLASS_MEMBER_FIELD(__vwsn_parameter_ViewModel)
				CLASS_MEMBER_PROPERTY_READONLY(ViewModel, GetViewModel)
			...
			BEGIN_CLASS_MEMBER(::gacpass::NewCodeWindow)
				CLASS_MEMBER_BASE(::vl::presentation::controls::GuiWindow)
				CLASS_MEMBER_BASE(::gacpass::NewCodeWindowConstructor)
				CLASS_MEMBER_CONSTRUCTOR(::gacpass::NewCodeWindow*(::vl::Ptr<::gacpass::ICodeBookViewModel>), { L"__vwsn_ctor_parameter_CodeBookViewModel" })
				CLASS_MEMBER_METHOD(GetCodeBookViewModel, NO_PARAMETER)
				CLASS_MEMBER_METHOD(GetForEdit, NO_PARAMETER)
				CLASS_MEMBER_METHOD(SetCode, { L"value" })
			...
			END_CLASS_MEMBER(::gacpass::NewCodeWindow)

			BEGIN_CLASS_MEMBER(::gacpass::NewCodeWindowConstructor)
				CLASS_MEMBER_BASE(::vl::reflection::DescriptableObject)
				CLASS_MEMBER_CONSTRUCTOR(::vl::Ptr<::gacpass::NewCodeWindowConstructor>(), NO_PARAMETER)
				CLASS_MEMBER_METHOD(__vwsn_gacpass_NewCodeWindow_Initialize, { L"__vwsn_this_" })
				CLASS_MEMBER_FIELD(__vwsn_precompile_0)
				CLASS_MEMBER_FIELD(__vwsn_precompile_1)
				CLASS_MEMBER_FIELD(__vwsn_precompile_10)
				CLASS_MEMBER_FIELD(__vwsn_precompile_11)
			...
			END_CLASS_MEMBER(::gacpass::NewCodeWindowConstructor)

			BEGIN_CLASS_MEMBER(::gacpass::RegisterWindow)
				CLASS_MEMBER_BASE(::vl::presentation::controls::GuiCustomControl)
				CLASS_MEMBER_BASE(::gacpass::RegisterWindowConstructor)
				CLASS_MEMBER_CONSTRUCTOR(::gacpass::RegisterWindow*(::vl::Ptr<::gacpass::IViewModel>), { L"__vwsn_ctor_parameter_ViewModel" })
				CLASS_MEMBER_METHOD(GetViewModel, NO_PARAMETER)
				CLASS_MEMBER_FIELD(__vwsn_parameter_ViewModel)
				CLASS_MEMBER_PROPERTY_READONLY(ViewModel, GetViewModel)
...
#undef _
			...
			public:
				void Load(ITypeManager* manager)
				{
					...
					ADD_TYPE_INFO(::gacpass::NewCodeWindow)
					ADD_TYPE_INFO(::gacpass::NewCodeWindowConstructor)
