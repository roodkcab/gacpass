...
#define _ ,
			...
			BEGIN_CLASS_MEMBER(::gacpass::EditCodeWindowConstructor)
				...
				CLASS_MEMBER_FIELD(self)
				CLASS_MEMBER_FIELD(textBoxGoogleKey)
			...
			BEGIN_INTERFACE_MEMBER(::gacpass::ICode)
				...
				CLASS_MEMBER_METHOD(GetGoogleCode, NO_PARAMETER)
				CLASS_MEMBER_METHOD(GetGoogleKey, NO_PARAMETER)
				...
				CLASS_MEMBER_METHOD(SetGoogleKey, { L"__vwsn_value_" })
				...
				CLASS_MEMBER_PROPERTY_READONLY(GoogleCode, GetGoogleCode)
				CLASS_MEMBER_PROPERTY(GoogleKey, GetGoogleKey, SetGoogleKey)
