...
#define _ ,
			BEGIN_CLASS_MEMBER(::gacpass::CodeBookWindow)
				...
				CLASS_MEMBER_CONSTRUCTOR(::gacpass::CodeBookWindow*(::vl::Ptr<::gacpass::ICodeBookViewModel>, ::vl::Ptr<::gacpass::IEditCodeViewModel>, ::vl::presentation::controls::GuiWindow*), { L"__vwsn_ctor_parameter_ListViewModel" _ L"__vwsn_ctor_parameter_EditCodeViewModel" _ L"__vwsn_ctor_parameter_MainWindow" })
